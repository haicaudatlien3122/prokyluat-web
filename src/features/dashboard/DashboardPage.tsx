  ...
  return (
    <div className="flex-1 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <div className="col-span-4 flex flex-col rounded-xl border bg-card text-card-foreground shadow p-6 min-h-[300px]">
        ...
        <div className="col-span-3 flex flex-col rounded-xl border bg-card text-card-foreground shadow p-6 min-h-[300px]">
